function solve(input) {
    ...
    // let patternWords = /([::|**]{2})(?<word>[A-Za-z]{3,})\1/g //  /([#@]+)(?<word>[\w]{6,})\1/g
    let patternWords = /([::|**]{2})(?<word>[A-Z][a-z]{2,})\1/g //  /([#@]+)(?<word>[\w]{6,})\1/g
    let patternDigits = /(?<digitIter>[0-9])/g
    let matchDigits = text.match(patternDigits).map(Number).reduce((a, b) => a * b, 1);
