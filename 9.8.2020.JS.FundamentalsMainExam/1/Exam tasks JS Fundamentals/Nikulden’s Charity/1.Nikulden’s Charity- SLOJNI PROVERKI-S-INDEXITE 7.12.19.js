function solve(input) {
    ...
    function replacing(message, first, second) {          //PROVERKA DALI SE SADARJA ELEMENTA s INDEXOF >=0
    ...
    function upper(message) {                          //UPPER-CASE

        message = message.toUpperCase();
        return message
    }

    function lower(message) {                           //LOWER - CASE
    ...
    function checking(message, word) {
        ...
        if (message.includes(word)) {                     // INCLUDES IN STRING
    ...
    function summing(message, first, second) {             //SUMMING substr + CHARCODEAT!!!
    ...
    function cutting(message, first, second) {             //SLICE  -  substr + concat
